...
class Ephemeris:
    ...
    def __init__(self):
        ...
        #
        self.planets['mercury'] = {'mass':3.301*1e23, 'T':87.9691 , 'inc':[7.00497902, -0.00594749], 'Om':[48.33076593, -0.12534081], 'omega':[77.45779628, 0.16047689], 'a':[0.38709927, 0.00000037], 'e':[0.20563661, 0.00001906], 'l0':[252.25032350, 149472.67411175]}
        self.planets['venus'] = {'mass':4.867*1e24, 'T':224.7, 'inc':[3.39467605, -0.00078890], 'Om':[76.67984255, -0.27769418], 'omega':[131.60246718, 0.00268329], 'a':[0.72333566, 0.00000390], 'e':[0.00676399, -0.00004107], 'l0':[181.97909950, 58517.81538729]}
        self.planets['earth'] = {'mass':5.972*1e24, 'T':365.25636, 'inc':[-0.00001531, -0.01294668], 'Om':[0., 0.], 'omega':[102.93768193, 0.32327364], 'a':[1.00000261, 0.00000562], 'e':[0.01673163, -0.00004392], 'l0':[100.46457166, 35999.37244981]}
        self.planets['mars'] = {'mass':6.417*1e23, 'T':687.0, 'inc':[1.84969142, -0.00813131], 'Om':[49.55953891, -0.29257343], 'omega':[-23.94362959, 0.44441088], 'a':[1.52371034, 0.00001847], 'e':[0.09336511, 0.00007882], 'l0':[-4.55343205, 19140.30268499]}
        self.planets['jupiter'] = {'mass':1.899*1e27, 'T':4331, 'inc':[1.30439695, -0.00183714], 'Om':[100.47390909, 0.20469106], 'omega':[14.72847983, 0.21252668], 'a':[5.20288700, -0.00011607], 'e':[0.04853590, -0.00013253], 'l0':[34.39644051, 3034.74612775]}
        self.planets['saturn'] = {'mass':5.685*1e26, 'T':10747, 'inc':[2.48599187, 0.00193609], 'Om':[113.66242448, -0.28867794], 'omega':[92.59887831, -0.41897216], 'a':[9.53667594,-0.00125060 ], 'e':[0.05550825, -0.00050991], 'l0':[49.95424423, 1222.49362201]}
        self.planets['uranus'] = {'mass':8.683*1e25, 'T':30589, 'inc':[0.77263783, -0.00242939], 'Om':[74.01692503, 0.04240589], 'omega':[170.95427630, 0.40805281], 'a':[19.18916464, -0.00196176], 'e':[0.04685740, -0.00004397], 'l0':[313.23810451, 428.48202785]}
        self.planets['neptune'] = {'mass':1.024*1e26, 'T':59800, 'inc':[1.77004347, 0.00035372], 'Om':[131.78422574, -0.00508664], 'omega':[44.96476227, -0.32241464], 'a':[30.06992276, 0.00026291], 'e':[0.00895439, 0.00005105], 'l0':[-55.12002969, 218.45945325]}
